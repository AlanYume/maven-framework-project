        ...
        <form name='f' action="<c:url value='j_spring_security_check' />" method='POST'
            ...
            <fieldset>
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type='text' name='j_username'
                               value="<sec:authentication property="name"/>" placeholder="用户名"
                               id="j_username" class="input-medium search-query">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type='password' name='j_password' placeholder="密码" id="j_password"
